# telegram-source Specification

## Purpose
Support public Telegram channels as local-first feedctl content sources without requiring MTProto credentials, Bot API credentials, user login, or stored account sessions.
